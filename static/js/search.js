...
async function onSubmit() {
  ...
  const geoLocationRaw = await fetch(
    `https://maps.googleapis.com/maps/api/geocode/json?address=${location}&key=AIzaSyCxppIUKkdemcOA-ywan8e7cuOiVD2pafE`
  );
...
function venueshowfill(venuelist) {
  let venuebutton =
    "<div class='venueshow' onclick='venuelist(\"" + venuelist + "\")'>" +
